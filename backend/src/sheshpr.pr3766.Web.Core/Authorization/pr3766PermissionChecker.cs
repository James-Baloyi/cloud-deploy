...
{
    /// <summary>
    /// pr3766 Permission checker
    /// </summary>
    public class pr3766PermissionChecker : ICustomPermissionChecker, Ipr3766PermissionChecker
    {
        ...
        /// Default constructor
        /// </summary>
        public pr3766PermissionChecker(IRepository<Person, Guid> personRepository, IRepository<ShaRoleAppointedPerson, Guid> rolePersonRepository, IRepository<ShaRoleAppointmentEntity, Guid> appEntityRepository)
        {
