...
using sheshpr.pr3766.Tests.DependencyInjection;
using Shesha;
...
namespace sheshpr.pr3766.Common.Tests
{
    [DependsOn(
        typeof(pr3766Module),
    ...
    public class pr3766CommonDomainTestModule : AbpModule
    {
        private string ConnectionString;

        public pr3766CommonDomainTestModule(SheshaNHibernateModule nhModule)
        {
